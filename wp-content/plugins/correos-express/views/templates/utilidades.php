            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="mt-5">
                    <ul id="CEX-tabs-menu" class="nav nav-tabs border-0" role="tablist">
                        <li id="introjsGrabacionMasiva" class="nav-item ">
                            <a class="nav-link active px-2" data-toggle="tab" role="tab" href="#grabar_envios"
                        ...
                        <li id="introjsReimpresion" class="nav-item ">
                            <a class="nav-link px-2" data-toggle="tab" role="tab" href="#cex_generar_etiquetas"
                        ...
                        <li id="introjsResumen" class="nav-item ">
                            <a class="nav-link px-2" data-toggle="tab" role="tab" href="#cex_generar_resumen"
                ...
                <div id="CEX-tab-content"
                    class="tab-content border border-0 CEX-background-bluelight2 p-md-3 rounded-2 rounded-md-top-left-0 d-block"
                    role="tablist">
                            ...
                            <div class="b-body container-fluid pb-3">
                                <div class="row text-center m-0">
                                    ...
                                    <div class="col-12 col-xs-12 col-md-12 col-lg-12 form-group">
                                        <button type="button" class="CEX-btn CEX-button-blue"
