...
<div id="CEX" class="CEX-panel">
    ...
    function guardarDatosUser() {
        ...
        if((jQuery)('#MXPS_CHECKUPLOADFILE').prop('checked')){
        ...
        (jQuery).ajax({
            ...
            success: function(msg) {               
                ...
                if(retorno.imagenLogo){                    
                    ...
                    var img = "<img class='img-logo w-50' id='imagenLogoEtiqueta' src='"+retorno.imagenLogo+"?lastmodified="+random+"'>";
                    (jQuery)('#divImagenLogo').html(img);
                }                
            },
            error: function(msg) {
   ...
   function guardarCredenciales(){
    ...
    function cambiar_estado_enableOfficeDelivery() {
        ...
        if ((jQuery)('#MXPS_ENABLEOFFICEDELIVERY').prop('checked') == false) {
            //console.log("marcar como Cancelado");
        }
    }
    ...
    function pintarEstadosFormularioUser(msg) {
        ...
        //console.log(retorno.MXPS_CRONINTERVAL);
        //CHECKBOXES        
        ...
        if (retorno.MXPS_CHECKUPLOADFILE == "true") {
            (jQuery)("#MXPS_CHECKUPLOADFILE").attr("checked", "checked");
    ...
    <div id="modal_codigo_client" class="CEX-container container  mt-1 mb-3 pr-5 d-none" role="dialog">
        <div class="row">
            <div class="CEX-background-bluelight2 CEX-text-blue p-3 rounded col-12">
    ...
    <div id="remitente" class="CEX-container container  mt-1 mb-3 pr-5 d-none" role="dialog">
        <div class="row">
            <div class="CEX-background-bluelight2 CEX-text-blue p-3 rounded col-12">
                <!-- Modal content-->
                <div class="modal-header border-0">
                ...
                <div class="modal-footer border-0 text-center">
                    ...
                    <button type="button" id="cerrar_modal_remitente" class="CEX-btn CEX-button-red"
