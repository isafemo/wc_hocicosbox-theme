...
class Customizer_Repeater extends WP_Customize_Control {
    ...
    public $customizer_repeater_test = false;
	...
	public function __construct( $manager, $id, $args = array() ) {
        ...
        if ( ! empty( $args['customizer_repeater_test'] ) ) {
            $this->customizer_repeater_test= $args['customizer_repeater_test'];
        }
	...
	public function enqueue() {
		wp_enqueue_style( 'font-awesome', get_template_directory_uri().'/inc/customizer/customizer-repeater/css/font-awesome.min.css', array(), '1.1.0' );

		wp_enqueue_style( 'customizer-repeater-admin-stylesheet', get_template_directory_uri().'/inc/customizer//customizer-repeater/css/admin-style.css', array(), '1.1.0' );

		wp_enqueue_style( 'wp-color-picker' );

		wp_enqueue_script( 'customizer-repeater-script', get_template_directory_uri() . '/inc/customizer//customizer-repeater/js/customizer_repeater.js', array('jquery', 'jquery-ui-draggable', 'wp-color-picker' ), '1.1.0', true  );

		wp_enqueue_script( 'customizer-repeater-fontawesome-iconpicker', get_template_directory_uri() . '/inc/customizer//customizer-repeater/js/fontawesome-iconpicker.min.js', array( 'jquery' ), '1.1.0', true );

		wp_enqueue_style( 'customizer-repeater-fontawesome-iconpicker-script', get_template_directory_uri() . '/inc/customizer//customizer-repeater/css/fontawesome-iconpicker.min.css', array(), '1.1.0' );
	}
...
//						}
            ...
            <div class="customizer-repeater-general-control-repeater-container">
                ...
                <div class="customizer-repeater-box-content-hidden">
                    ...
                    if ( $this->customizer_repeater_test == true ) {
                        $this->image_control();
                    }
					?>
