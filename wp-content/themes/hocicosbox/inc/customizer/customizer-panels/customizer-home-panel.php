...
if (!function_exists('hb_general_home_wpcustomize')) {
    ...
    add_action('customize_register', 'hb_general_home_wpcustomize');
    /**
     * Customize Panel.
     *
     ...
     * @since  1.0.0
     */
    function hb_general_home_wpcustomize($wp_customize)
    {
        // Panel: Basic.
        $wp_customize->add_panel('hb_general_home_wpcustomize', array(
            'priority' => 10,
            'title' => __('Home', 'WPC'),
