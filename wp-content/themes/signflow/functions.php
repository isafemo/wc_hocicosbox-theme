...
function signflow_get_post_info() {
    ...
    $txt .= '<span class="info-cat"><i class="icon-folder-open"></i> ';
    ...
    $txt .= '</span><span class="info-author"><i class="icon-quote"></i> <a href="' . get_author_posts_url(get_the_author_meta("ID")) . '">' . get_the_author() . '</a></span>';
    $output = '';
    ...
    if ($posttags) {
        ...
        $txt .= '<i class="icon-pricetags"></i> ' . trim( $output, $separator );
    }
    return $txt . '</div>';
}
