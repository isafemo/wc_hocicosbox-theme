				...
				return this.each(function () {
						...
						var meanCentered = function() {
							if (meanRevealPosition === "center") {
								...
								if (!isMobile) {
									jQuery(meanContainer).find('.meanmenu-reveal').css("left",meanCenter);
								} else {
									jQuery(meanContainer).find('.meanmenu-reveal').animate({
											left: meanCenter
									});
								}
							}
						...
						var meanOriginal = function() {
							jQuery(meanContainer).find('.mean-bar,.mean-push').remove();
