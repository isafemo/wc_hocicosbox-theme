<?php
	/* TopBar */
	$businessexpo_topbar = get_theme_mod( 'businessexpo_topbar_enabled', false );
	$businessexpo_phone = get_theme_mod( 'businessexpo_tbar_phone_text', '+012-012' );
	$businessexpo_email = get_theme_mod( 'businessexpo_tbar_email_text', 'mail@gmail.com' );
	$businessexpo_btn = get_theme_mod( 'businessexpo_tbar_btn_text', 'Buy Now' );
	$businessexpo_btn_url = get_theme_mod( 'businessexpo_tbar_btn_url', 'mail@gmail.com' );
