...
function businessexpo_default_theme_options_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'businessexpo_custom_background_args', 
		array(
...
function businessexpo_backend_resources(){
	...
	//CSS
	wp_enqueue_style( 'bootstrap-min-css',BUSINESSEXPO_THEME_URL . '/assets/css/bootstrap.min.css');	
...
function businessexpo_admin_enqueue_scripts(){
    ...
    wp_localize_script( 'businessexpo-admin-script', 'businessexpo_ajax_object',
