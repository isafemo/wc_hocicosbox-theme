 ...
 */
class businessexpo_Customize_Recommended_Plugin_Section extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'businessexpo-plugin-section';
	 ...
	 * @var    string
	 */
	public $businessexpo_plugin_url = '';
