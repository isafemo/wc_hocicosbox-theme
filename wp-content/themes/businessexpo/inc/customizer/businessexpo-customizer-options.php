    ...
    'recommended_plugins' => array( 
        'wpfrank-companion' => array(
            ...
            'description' => sprintf( 
                ...
                esc_html__( 'If you want to show all the features and business sections of the FrontPage. please install and activate %s plugin', 'businessexpo' ), '<strong>WpFrank Companion</strong>' 
            ),
        ),
    ),
