	...
	<div class="themepage_info_column clearfix">
		<div class="themepage_info_left">
			...
			<div class="themepage_link">
				...
				<p>
					<a href="<?php echo esc_url( '//helpdocs.britetechs.com/docs/spawp-premium-plugin/' ); ?>" target="_blank" class="button button-secondary"><?php esc_html_e('Spawp Theme Documentation', 'spawp'); ?></a>
				</p>
			...
			<div class="themepage_link">
				...
				<p>
					<a href="<?php echo esc_url('//www.britetechs.com/support/' ); ?>" target="_blank" class="button button-secondary"><?php echo sprintf( esc_html__('Create a ticket', 'spawp'), 'Spawp'); ?></a>
				</p>
			</div>
		</div>
